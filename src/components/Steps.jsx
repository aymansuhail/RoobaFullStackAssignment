...
const disabled = ({ annotations }) => {
  return (
    <div className="p-[20px] flex flex-col justify-between border-y-[1px]">
  ...
  return (
    <div className="p-[20px] flex flex-col justify-between border-y-[1px]">
      <div className="flex items-center justify-between">
        <div className="flex items-start space-x-5">
          <div className="relative h-5 w-5">
            ...
            >
              <path
                d="M9.1207 19.8887L0.0957031 10.8637L2.35195 8.60742L9.1207 15.3762L23.6478 0.849091L25.904 3.10534L9.1207 19.8887Z"
                fill="#5BB663"
              />
            </svg>
          </div>
          <div>
            <>
              ...
              <p className="text-buttonbg opacity-80 text-sm">
                {annotations.text2}
              </p>
            </>
        ...
        <div className="self-start">{annotations.date}</div>
      </div>
      <button className="flex items-center justify-center space-x-2 w-[169px] h-[52px]  text-buttonbg border-buttonbg border-[1px] self-end">
        ...
        >
          <path
            d="M0 10.3887V9.38867H8V10.3887H0ZM4 8.38867L0.5 3.88867H2.5V0.388672H5.5V3.88867H7.5L4 8.38867ZM4 6.76367L5.45 4.88867H4.5V1.38867H3.5V4.88867H2.55L4 6.76367Z"
            fill="#4375FB"
          />
        </svg>
      </button>
...
const Steps = ({ condition, annotations, future }) => {
  if (condition === "incomplete")
    return incomplete({ condition, annotations, future });
  if (condition === "disabled") return disabled({ annotations });
  if (condition === "complete")
    return complete({ condition, annotations, future });
};
