...
const three_obj_complete = {
  ...
  annotations: {
    text1: "Step 3",
    text2: "We will get back to you in 3 months",
    text3: "Complete",
    date: "16/12/2023",
    buttonText: "Download",
  },
    ...
    <div className="overflow-y-auto h-[calc(170vh-200px)] p-[20px] md:p-[60px] pb-0 space-y-0 border-t-[1px]">
      ...
      <div className="grid h-fit grid-rows-[1fr_1/2fr] md:grid-rows-[auto_auto] lg:grid-cols-[1fr_1fr] p-[15px] md:p-[30px] border-b-[1px] border-t-[2px] border-l-[2px] border-r-[2px] ">
        <div className="space-y-8">
          ...
          <div className="space-y-2">
            ...
            <div className="grid grid-cols-[90px_90px] w-[80vw]  md:w-auto md:flex md:items-center md:justify-between">
              <div className=" m-1 ml-0 md:m-0 bg-badgebg h-[16px] w-[79px] flex items-center justify-around">
                ...
                >
                  <path
                    d="M5.03329 11.1333L8.48329 7.00001H5.81663L6.29996 3.21668L3.21663 7.66668H5.53329L5.03329 11.1333ZM3.33329 13.6667L3.99996 9.00001H0.666626L6.66663 0.333344H7.99996L7.33329 5.66668H11.3333L4.66663 13.6667H3.33329Z"
                    fill="#1C1B1F"
                  />
                </svg>
                <p className="text-[10px] font-normal md:font-light text-badgetext">
                  Adult rides
                </p>
              </div>
              <div className="m-1 ml-0 md:m-0 bg-badgebg h-[16px] w-[79px] flex items-center justify-around">
              ...
              <div className="m-1 ml-0 md:m-0 bg-badgebg h-[16px] w-[79px] flex items-center justify-around">
                ...
                >
                  <path
                    d="M0.333374 12V2L3.00004 0L5.00004 1.5L7.00004 0L9.00004 1.5L11 0L13.6667 2V12H0.333374ZM1.66671 10.6667H4.33337V2.66667L3.00004 1.66667L1.66671 2.66667V10.6667ZM5.66671 10.6667H8.33337V2.66667L7.00004 1.66667L5.66671 2.66667V10.6667ZM9.66671 10.6667H12.3334V2.66667L11 1.66667L9.66671 2.66667V10.6667Z"
                    fill="#1C1B1F"
                  />
                </svg>
                <p className="text-[10px] font-normal md:font-light text-badgetext">
          ...
          <div className="px-[10px] py-[5px] w-[226px] border-[1px] border-[#4375FB] flex items-center space-x-2">
            ...
            >
              <path
                d="M1.59947 10.3333L0.666138 9.39995L8.39947 1.66662H3.99947V0.333282H10.6661V6.99995H9.3328V2.59995L1.59947 10.3333Z"
                fill="#4375FB"
              />
            </svg>
            <p className="text-[#4375FB] text-[14px] underline">
          ...
          <div className="grid grid-cols-2 md:flex md:items-center md:space-x-3">
            <div className="w-[90px]">
              ...
              <p className="text-graytext text-[11px] font-medium md:font-normal">
                Area
              </p>
            </div>
            <div className="w-[90px]">
        ...
        <div className="mr-0 ml-auto md:m-0 md:flex md:flex-col md:space-y-1 lg:items-end ">
          <button className="bg-buttonbg h-[52px] mt-5 mb-3 w-[273px] text-buttontext">
            Complete Profile
          </button>
          <button className="text-buttonbg  float-left mr-0 ml-auto md:m-0 border-buttonbg border-[1px] h-[52px] w-[136px] px-[31px] py-[17px] bg-mywhite flex items-center space-x-2">
            ...
            >
              <path
                d="M1 -2.34446e-06L6 5L1 10L0.112499 9.1125L4.225 5L0.1125 0.887497L1 -2.34446e-06Z"
                fill="#4375FB"
              />
            </svg>
          </button>
      ...
      <div className="md:grid md:grid-cols-[1fr_1fr] border-t-[1px] border-l-[1px] border-r-[1px] m-0">
        <div className="h-[100vh] grid md:grid-rows-[237px_237px_237px_305px_480px] overflow-y-auto">
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-2">
                    ...
                    >
                      <path
                        d="M14 20.8058V17.5558H11V15.3891H14V12.1391H16V15.3891H19V17.5558H16V20.8058H14ZM14 9.97247V0.222473H16V9.97247H14ZM0 17.5558V0.222473H2V17.5558H0ZM7 4.55581V0.222473H9V4.55581H7ZM7 11.0558V6.72247H9V11.0558H7ZM7 17.5558V13.2225H9V17.5558H7Z"
                        fill="#4375FB"
                      />
                    </svg>
          ...
          <div className="p-[20px] space-y-4 border-[1px] border-r-0 flex flex-col">
            ...
            <button className="flex items-center self-end justify-evenly h-[52px] w-[136px] border-[1px] border-buttonbg text-buttonbg text-[14px]">
              ...
              >
                <path
                  d="M1 0.389158L6 5.38916L1 10.3892L0.112499 9.50166L4.225 5.38916L0.1125 1.27666L1 0.389158Z"
                  fill="#4375FB"
                />
              </svg>
            </button>
        ...
        <div className="overflow-y-auto h-[100vh] md:grid md:grid-rows-[repeat(6,200px)]">
          ...
          {(conditionState.condition.zero === "incomplete" && (
            <Steps {...zero_obj} />
          )) ||
            (conditionState.condition.zero === "complete" && (
              <Steps {...zero_obj_complete} />
            ))}
          {(conditionState.condition.one === "disabled" && (
            <Steps {...one_obj} />
          )) ||
            (conditionState.condition.one === "incomplete" && (
              <Steps {...one_obj_incomplete} />
            )) ||
            (conditionState.condition.one === "complete" && (
              <Steps {...one_obj_complete} />
            ))}
          {(conditionState.condition.two === "disabled" && (
            <Steps {...two_obj} />
          )) ||
            (conditionState.condition.two === "incomplete" && (
              <Steps {...two_obj_incomplete} />
            )) ||
            (conditionState.condition.two === "complete" && (
              <Steps {...two_obj_complete} />
            ))}
          {(conditionState.condition.three === "disabled" && (
            <Steps {...three_obj} />
          )) ||
            (conditionState.condition.three === "incomplete" && (
              <Steps {...three_obj_incomplete} />
            )) ||
            (conditionState.condition.three === "complete" && (
              <Steps {...three_obj_complete} />
            ))}
          <Steps {...four_obj} />
          <Steps {...five_obj} />
        </div>
